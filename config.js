...
global.botscript = "https://github.com/Ronen6999/bo"
...
global.port = process.env.PORT || 50000
global.botnma = process.env.botnma || 'Meaow-Bot'//bot name
global.watermark = "©Ronenbotsinc"
global.dogeemoji = "🐱"
global.botname = process.env.botnamw || 'Meaow-bot'
global.ownernma = 'Ronen' //owner name
global.ownername = process.env.ownername || 'Ronen' //owner name
global.packname = 'Meaow-bot' //sticker package name
...
global.websitex = "https://youtube.com/c/RonenAMVs" //ur website
global.prefa = ['-'] //prefix
global.sp = '🐱' //design
global.mess = {
    ...
    owner: '𝐓𝐡𝐢𝐬 𝐂𝐨𝐦𝐦𝐚𝐧𝐝 𝐢𝐬 𝐨𝐧𝐥𝐲 𝐟𝐨𝐫 *Ronen* ' ,
    ...
    ban: 'You are banned by the Developer, if you want to be unbanned, chat with Ronen.',
